...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["You got a Star!",		        "Beat Cosmic Mario on Hard with no Misses.",		'cm_nomiss',			false],
		//["SO SCARY!!!",		            "Beat \"Jumpscare\" with Funny Blue Lobster.",      'js',                    true],
		["Waah!",		                "Beat \"Dark Plumber B-Side\" with Cosmic Luigi.",  'b-side',                true],
		["",	                        "",						                            '_nomiss',	             true],
		["",	                        "",						                            '.png',	                 true],
		["",	                        "",						                            '',	                     true],
		...
		//Name, Description, Achievement save tag, Hidden achievement
		/*Name, Description, Achievement save tag, Hidden achievement*/
		/*Name, Description, Achievement save tag, Hidden achievement true*/ //, //
		/*Name, Description, Achievement save tag, Hidden achievement false*/
		//Name, Description, Achievement save tag, Hidden achievement true
		/*Name, Description, Achievement save tag, Hidden achievement false*/
	];
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		achievementName.setFormat(Paths.font("delfino.otf"), 16, FlxColor.WHITE, LEFT);
		achievementName.scrollFactor.set();

		var achievementText:FlxText = new FlxText(achievementName.x, achievementName.y + 32, 280, Achievements.achievementsStuff[id][1], 16);
		achievementText.setFormat(Paths.font("delfino.otf"), 16, FlxColor.WHITE, LEFT);
