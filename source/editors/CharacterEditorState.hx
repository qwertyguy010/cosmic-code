...
class CharacterEditorState extends MusicBeatState
{
	...
	function reloadBGs() {
		...
		if(onPixelBG) {
			...
			var bg:BGSprite = new BGSprite('hive/hivebg', -600 + OFFSET_X - playerXDifference, -300, 0.9, 0.9);
			bgLayer.add(bg);
			...
			var ground:BGSprite = new BGSprite('hive/hiveground', -650 + OFFSET_X - playerXDifference, 500, 0.9, 0.9);
